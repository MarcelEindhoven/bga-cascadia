define(['dojo/_base/declare'], (declare) => {
    return declare('cascadia.usecase_place_wildlife', null, {
        ...
        subscribe_wildlife_placed(object, method) {
            this.habitat.subscribe_tile_selected_for_wildlife(this.candidate_tiles_specification, this, 'candidate_tile_selected');
        ...
        end_use_case() {
            this.habitat.unsubscribe_tile_selected_for_wildlife(this.candidate_tiles_specification, this, 'candidate_tile_selected');
        },
    });
});
